...
export const branchDirectory = {
  ...
  note: 'ยืนยันสาขาที่มีตัวตนจริงได้จากแหล่งข้อมูลออนไลน์ (Wongnai/LINE MAN, Facebook, TikTok, Lemon8, Google Maps) — ร้านเครื่องดื่มแฟรนไชส์เปิด-ปิดสาขาบ่อยและมีสาขาที่ยังไม่ขึ้นบนแพลตฟอร์มออนไลน์อยู่เสมอ ข้อมูลนี้ควรถือเป็นภาพ ณ ช่วงเวลาที่รวบรวม (ไม่ใช่ตัวเลขทางการ) โปรดตรวจสอบสถานะเปิด/ปิดของแต่ละสาขาอีกครั้งก่อนเดินทาง',
  regions: [
    {
      name: 'ภาคเหนือ',
      provinces: [
        {
          ...
          branches: [
            ...
            { name: 'พระสิงห์', location: '3/2 ต.พระสิงห์ อ.เมืองเชียงใหม่ 50200', phone: '094-629-5362' },
            { name: 'คำเที่ยง', location: 'ติดกับสถานีน้ำมัน ปตท. คำเที่ยง อ.สันกำแพง เชียงใหม่', phone: '091-032-2790' },
            { name: 'ป่าตาล สันผักหวาน', location: '329 ถนนวงแหวนรอบสอง ต.สันผักหวาน อ.หางดง เชียงใหม่', phone: '062-552-2483' },
          ],
        },
        {
          name: 'ลำปาง',
        ...
        },
        {
          ...
          branches: [
            ...
            { name: 'ตลาดแม่ก๊อรั้ว', location: 'อ.ป่าซาง ลำพูน', phone: '098-809-2264' },
          ],
        },
        {
          name: 'พะเยา',
    ...
    },
    {
      ...
      provinces: [
        ...
        },
        {
          ...
          count: '1 สาขา',
          branches: [
            { name: 'ตรงข้ามโรงเรียนอัสสัมชัญสมุทรปราการ', location: 'หน้า 7-11 รร.อัสสัมชัญ ปากซอยทิพวัล 41 ต.บางเมืองใหม่ อ.เมืองสมุทรปราการ' },
          ],
        },
      ],
    },
