      ...
      provinces: [
        {
          ...
          count: '16 สาขา',
          branches: [
            { name: 'หลัง มช.', location: 'ต.สุเทพ อ.เมืองเชียงใหม่', lat: 18.7923678, lng: 98.9562563 },
            { name: 'เจ็ดยอด', location: 'ต.ช้างเผือก อ.เมืองเชียงใหม่', lat: 18.8085144, lng: 98.9638515 },
            { name: 'ปตท. ฟ้าฮ่าม', location: 'ต.ฟ้าฮ่าม อ.เมืองเชียงใหม่', lat: 18.8145706, lng: 99.0124397 },
            { name: 'พระสิงห์', location: 'ต.พระสิงห์ อ.เมืองเชียงใหม่', lat: 18.7902103, lng: 98.9823037 },
            { name: 'ปั๊มบางจาก แม่เหียะ', location: 'ต.แม่เหียะ อ.เมืองเชียงใหม่', lat: 18.7406076, lng: 98.9649883 },
            { name: 'ตลาดแม่เหียะ', location: 'ต.แม่เหียะ อ.เมืองเชียงใหม่', lat: 18.7471664, lng: 98.941823 },
            { name: 'ป่าตาล สันผักหวาน', location: 'ต.สันผักหวาน อ.หางดง เชียงใหม่', lat: 18.7220263, lng: 98.9554462 },
            { name: 'สันกำแพง', location: 'อ.สันกำแพง เชียงใหม่', lat: 18.7455417, lng: 99.1188526 },
            { name: 'ปตท.กองทราย สารภี', location: 'อ.สารภี เชียงใหม่', lat: 18.7235373, lng: 99.0113767 },
            { name: 'ตลาดธานินทร์', location: 'อ.เมืองเชียงใหม่', lat: 18.8043957, lng: 98.9837583 },
            { name: 'แม่โจ้', location: 'ใกล้มหาวิทยาลัยแม่โจ้ อ.สันทราย เชียงใหม่', lat: 18.8965793, lng: 99.0082129 },
            { name: 'สันป่าตอง', location: 'อ.สันป่าตอง เชียงใหม่', lat: 18.620031, lng: 98.8965165 },
            { name: 'กาดก้อม', location: 'อ.เมืองเชียงใหม่', lat: 18.7747301, lng: 98.9907921 },
            { name: 'ฮอด', location: 'อ.ฮอด เชียงใหม่', lat: 18.1943929, lng: 98.6118449 },
            { name: 'ช่างเคี่ยน', location: 'ต.ช้างเผือก อ.เมืองเชียงใหม่', lat: 18.8106794, lng: 98.9586274 },
            { name: 'กาดฝรั่งแม่ริม', location: 'อ.แม่ริม เชียงใหม่', lat: 18.9020585, lng: 98.948574 },
          ],
        },
        {
          name: 'ลำปาง',
          count: '9 สาขา',
          branches: [
            { name: 'ตลาดน้ำโท้ง', location: 'ต.บ่อแฮ้ว อ.เมืองลำปาง', lat: 18.3091572, lng: 99.4666806 },
            { name: 'ตลาดบ้านฟ่อน', location: 'อ.เมืองลำปาง', lat: 18.2409348, lng: 99.437237 },
            { name: 'ตลาดออมสิน', location: 'ถ.บุญวาทย์ ต.สวนดอก อ.เมืองลำปาง', lat: 18.2888129, lng: 99.499269 },
            { name: 'ประตูม้า', location: 'ต.เวียงเหนือ อ.เมืองลำปาง', lat: 18.3000043, lng: 99.50524 },
            { name: 'เถิน', location: 'ต.ล้อมแรด อ.เถิน ลำปาง', lat: 17.6056722, lng: 99.2099697 },
            { name: 'พิชัย', location: 'ถ.พิชัย อ.เมืองลำปาง', lat: 18.3307326, lng: 99.5366496 },
            { name: 'ตลาดอัศวิน', location: 'ต.สบตุ๋ย อ.เมืองลำปาง', lat: 18.2893094, lng: 99.4873726 },
            { name: 'หน้าโรงเรียนลำปางกัลยาณี', location: 'ถ.พหลโยธิน ต.สวนดอก อ.เมืองลำปาง', lat: 18.2862413, lng: 99.4988374 },
            { name: 'ปตท.ห้างฉัตร', location: 'อ.ห้างฉัตร ลำปาง', lat: 18.3182383, lng: 99.3537972 },
          ],
        },
        {
          name: 'ลำพูน',
          count: '3 สาขา',
          branches: [
            { name: 'ตลาดลำพูนจตุจักร', location: 'อ.เมืองลำพูน', lat: 18.5568684, lng: 99.0359362 },
            { name: 'สันป่าฝ้าย', location: 'ต.บ้านกลาง อ.เมืองลำพูน', lat: 18.5831667, lng: 99.0485556 },
            { name: 'ตลาดแม่ทองริ้ว', location: 'อ.ป่าซาง ลำพูน', lat: 18.5331635, lng: 98.9400959 },
          ],
        },
        {
          name: 'พะเยา',
          count: '1 สาขา',
          branches: [
            { name: 'มหาวิทยาลัยพะเยา', location: 'ต.แม่กา อ.เมืองพะเยา', lat: 19.0341293, lng: 99.9274307 },
          ],
        },
        {
          name: 'เชียงราย',
          count: '3 สาขา',
          branches: [
            { name: 'รพ.เชียงรายประชานุเคราะห์', location: 'อ.เมืองเชียงราย', lat: 19.9005826, lng: 99.8292092 },
            { name: 'ประตูเชียงใหม่', location: 'อ.เมืองเชียงราย', lat: 19.9073192, lng: 99.8235533 },
            { name: 'Caltex เชียงราย', location: 'อ.เมืองเชียงราย', lat: 19.914406, lng: 99.8455305 },
          ],
        },
        {
          name: 'แม่ฮ่องสอน',
          count: '2 สาขา',
          branches: [
            { name: 'ปาย', location: 'อ.ปาย แม่ฮ่องสอน', lat: 19.3565617, lng: 98.439686 },
            { name: 'เมืองแม่ฮ่องสอน', location: 'อ.เมืองแม่ฮ่องสอน', lat: 19.3009133, lng: 97.9691271 },
          ],
        },
        {
          name: 'ตาก',
          count: '1 สาขา',
          branches: [
            { name: 'แม่สอด', location: 'อ.แม่สอด ตาก', lat: 16.7192965, lng: 98.5908706 },
          ],
        },
      ],
    },
      ...
      provinces: [
        {
          ...
          count: '1 สาขา',
          branches: [
            { name: 'ตรงข้ามโรงเรียนอัสสัมชัญสมุทรปราการ', location: 'หน้า 7-11 รร.อัสสัมชัญ ปากซอยทิพวัล 41 ต.บางเมืองใหม่ อ.เมืองสมุทรปราการ', lat: 13.628047, lng: 100.6054351 },
          ],
        },
      ],
    },
      ...
      provinces: [
        {
          ...
          count: '1 สาขา',
          branches: [
            { name: 'บางแสน', location: 'ซอยสดใส บางแสน อ.เมืองชลบุรี', lat: 13.27964, lng: 100.9322112 },
          ],
        },
      ],
    },
