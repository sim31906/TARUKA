...
window.DEFAULT_CONTENT = {
  ...
  about: {
    ...
    body:
      "เราจำหน่ายเครื่องดื่มหลากหลายประเภท มีให้เลือกมากกว่า 50 เมนู โดยเราคัดสรรวัตถุดิบคุณภาพ และคิดค้นสูตรพิเศษ เพื่อให้มีรสชาติเป็นเอกลักษณ์ แตกต่างจากท้องตลาด และพัฒนาสร้างสรรค์เมนูเครื่องดื่มใหม่ ๆ อย่างสม่ำเสมอ",
    images: [],
  },
