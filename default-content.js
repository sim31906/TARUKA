...
window.DEFAULT_CONTENT = {
  ...
  hero: {
    title: "TARUKA",
    subtitle:
      "ชานมไข่มุก เราจำหน่ายเครื่องดื่มหลากหลายประเภท มีให้เลือกมากกว่า 50 เมนู โดยเราคัดสรรวัตถุดิบ ใช้วัตถุดิบคุณภาพและคิดค้นสูตรพิเศษ เพื่อให้มีรสชาติเป็นเอกลักษณ์แตกต่างจากท้องตลาด และพัฒนาสร้างสรรค์เมนูเครื่องดื่มใหม่ๆอย่างสม่ำเสมอ",
